...
<head>
  ...
  <link href="../assets/css/dashboard-user.css" rel="stylesheet">
	...
	<link rel="stylesheet" href="../assets/css/educ/main.css">
							...
							<ul>
								<li>
									<a class="justify-content-between d-flex" href="#">
										<p>Title:</p> 
										<span class="or">Student Election</span>
									</a>
								</li>
								<li>
									<a class="justify-content-between d-flex" href="#">
										<p>Teacher:</p>
										<span>Mr. Client Frilles</span>
									</a>
								</li>
								<li>
									<a class="justify-content-between d-flex" href="#">
			...
			<section class="popular-courses-area section-gap courses-page">
				<div class="container">
					...
					<div class="row">
						...
						<a href="#" class="primary-btn text-uppercase mx-auto" style="width: 250px; text-align:center;">Load More Courses</a>													
					</div>
				</div>	
			</section>
