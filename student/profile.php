      ...
      <div class="col-lg-4">
        <div class="card mb-4">
          <div class="card-body text-center">
            ...
            <p class="text-muted mb-4">BS in Information Technology 4-1</p>
        ...
        <div class="card mb-4">
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-sm-9">
                <p class="text-muted mb-0">Camille Anne Gaintano Sabile</p>
              </div>
            </div>
            <hr>
            <div class="row">
              ...
              <div class="col-sm-9">
                <p class="text-muted mb-0">Victoria Homes Tunasan Muntinlupa City Metro Manila, 1773</p>
              </div>
            </div>
            <hr>
            <div class="row">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card mb-4 mb-md-0">
              <div class="card-body">
                <p class="mb-4">Class Schedule</p>
                <p class="mb-1" style="font-size: .90rem;">Web Design</p>
                <div class="progress rounded">
                <p style="font-size: .77rem;">Friday 10:30-1:30</p>
                </div>

                <p class="mt-4 mb-1" style="font-size: .90rem;">Website Markup</p>
                <div class="progress rounded">
                <p style="font-size: .77rem;">Friday 10:30-1:30</p>
                </div>
