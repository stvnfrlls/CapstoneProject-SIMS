    ...
    <div class="container my-5">
        ...
        <div class="mb-3">
            <ul class="nav nav-pills justify-content-center">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link" href="schedule.php">Class Scheduling</a>
                </li>
            </ul>
        </div>
                                            ...
                                            if ($resultgetEnrolledStudents->num_rows >= 0) {
                                                while ($EnrolledData = $resultgetEnrolledStudents->fetch_assoc()) { ?>
                                                    <tr>
                                                        ...
                                                        <td class="hatdog"><input type="hidden" name="SR_number" placeholder="<?php echo $EnrolledData['SR_number'] ?>"><?php echo $EnrolledData['SR_number'] ?></td>
                                                        <td class="hatdog"><input type="number" name="G_english" placeholder="<?php echo $EnrolledData['G_english'] ?>" style="text-align: center;"></td>
                                                        <td class="hatdog"><input type="number" name="G_math" placeholder="<?php echo $EnrolledData['G_math'] ?>" style="text-align: center;"></td>
                                                        <td class="hatdog"><input type="number" name="G_science" placeholder="<?php echo $EnrolledData['G_science'] ?>" style="text-align: center;"></td>
                                                        <td class="hatdog"><input type="number" name="G_history" placeholder="<?php echo $EnrolledData['G_history'] ?>" style="text-align: center;"></td>
                                                        <td class="hatdog"><input type="number" name="G_filipino" placeholder="<?php echo $EnrolledData['G_filipino'] ?>" style="text-align: center;"></td>
                                                        <td class="hatdog">
