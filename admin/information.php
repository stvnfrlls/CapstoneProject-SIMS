    ...
    <div class="container my-5">
        ...
        <div class="mb-3">
            <ul class="nav nav-pills justify-content-center">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" href="information.php">Student Information</a>
                </li>
                <li class="nav-item" role="presentation">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="studentrecords">
                                    ...
                                    <div class="card p-3">
                                        ...
                                        <div class="row g-3 mb-3">
                                            <div class="col-6 form-group">
                                                ...
                                                <input type="text" class="form-control fullwidth " id="SR_number" name="SR_number" required>
                                            </div>
                                            <div class="col-6 form-group">
                                                <label for="SR_yearlevel" class="form-label">Year Level</label>
                                                <select class="form-select form-control fullwidth" id="SR_yearlevel" name="SR_yearlevel" required>
                                                    <option value=""></option>
                                                    <option value="Male">Male</option>
                                                    <option value="Female">Female</option>
                                                    <option value="NA">Prefer not to say</option>
