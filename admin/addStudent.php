                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row" style="padding-bottom: 15px;">
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <select class="form-select form-control" name="S_gender" required>
                                                                            <option value=""></option>
                                                            ...
                                                            <div class="row" style="padding-bottom: 15px;">
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <input type="text" class="form-control" name="S_postal" required>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row" style="padding-bottom: 15px;">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <input type="text" class="form-control" name="S_guardian" required>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row" style="padding-bottom: 15px;">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <select class="form-select form-control" name="S_gradelevel" required>
