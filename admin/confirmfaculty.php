                            ...
                            <form class="form-sample" action="<?php $_SERVER["PHP_SELF"] ?>" method="POST">
                              ...
                              <div class="row" style="padding-bottom: 15px;">
                                <div class="col-md-4">
                                  ...
                                  <div class="col-sm-12">
                                    <select class="form-select form-control" name="department" readonly>
                                      <option value=""></option>
                              ...
                              <div class="row" style="padding-bottom: 15px;">
                                ...
                                <div class="row" style="padding-bottom: 15px;">
                                  ...
                                  <div class="col-md-4">
                                    ...
                                    <div class="col-sm-12">
                                      <select class="form-select form-control" name="gender" readonly>
                                        <option value=""></option>
                                ...
                                <div class="row" style="padding-bottom: 15px;">
                                  ...
                                  <div class="col-md-4">
                                    ...
                                    <div class="col-sm-12">
                                      <input type="text" class="form-control" name="postal" readonly>
                                    </div>
                                  </div>
                                ...
                                <div class="row" style="padding-bottom: 15px;">
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <div class="col-sm-12">
                                      <input type="text" class="form-control" name="contact" readonly>
                                    </div>
                                  </div>
