...
$getStudentGrades = $mysqli->query("SELECT * FROM grades WHERE SR_number = '{$_SESSION['SR_number']}'");
...
$getGradeAve = $mysqli->query("SELECT ROUND(AVG(G_finalgrade)) AS average FROM grades where SR_number = '{$_SESSION['SR_number']}'");
...
$pdf->SetFont('Arial', '', 9);
$getBehaviorData = $mysqli->query("SELECT * FROM behavior where SR_number = '{$_SESSION['SR_number']}'");
...
$getMakaDiyos1 = $mysqli->query("SELECT * FROM behavior WHERE CV_Area = 'Maka-Diyos1' AND SR_number = '{$_SESSION['SR_number']}'");
...
$getMakaDiyos2 = $mysqli->query("SELECT * FROM behavior WHERE CV_Area = 'Maka-Diyos2' AND SR_number = '{$_SESSION['SR_number']}'");
...
$getMakatao1 = $mysqli->query("SELECT * FROM behavior WHERE CV_Area = 'Makatao1' AND SR_number = '{$_SESSION['SR_number']}'");
...
$getMakatao2 = $mysqli->query("SELECT * FROM behavior WHERE CV_Area = 'Makatao2' AND SR_number = '{$_SESSION['SR_number']}'");
...
$getMakabansa1 = $mysqli->query("SELECT * FROM behavior WHERE CV_Area = 'Makabansa1' AND SR_number = '{$_SESSION['SR_number']}'");
...
$getMakabansa2 = $mysqli->query("SELECT * FROM behavior WHERE CV_Area = 'Makabansa2' AND SR_number = '{$_SESSION['SR_number']}'");
...
$getMakalikasan = $mysqli->query("SELECT * FROM behavior WHERE CV_Area = 'Makalikasan' AND SR_number = '{$_SESSION['SR_number']}'");
...
$pdf->SetFont('Arial', '', 9);
$SEP = $mysqli->query("SELECT COUNT(A_status) FROM attendance WHERE SR_number = '{$_SESSION['SR_number']}' AND MONTHNAME(A_date) = 'September' AND A_status = 'LATE'");
$SEPvalue = $SEP->fetch_assoc();
$pdf->Cell(10, 5, $SEPvalue['COUNT(A_status)'], 1, 0, 'C');

$OCT = $mysqli->query("SELECT COUNT(A_status) FROM attendance WHERE SR_number = '{$_SESSION['SR_number']}' AND MONTHNAME(A_date) = 'October' AND A_status = 'LATE'");
$OCTvalue = $OCT->fetch_assoc();
$pdf->Cell(10, 5, $OCTvalue['COUNT(A_status)'], 1, 0, 'C');

$NOV = $mysqli->query("SELECT COUNT(A_status) FROM attendance WHERE SR_number = '{$_SESSION['SR_number']}' AND MONTHNAME(A_date) = 'November' AND A_status = 'LATE'");
$NOVvalue = $NOV->fetch_assoc();
$pdf->Cell(10, 5, $NOVvalue['COUNT(A_status)'], 1, 0, 'C');

$DEC = $mysqli->query("SELECT COUNT(A_status) FROM attendance WHERE SR_number = '{$_SESSION['SR_number']}' AND MONTHNAME(A_date) = 'December' AND A_status = 'LATE'");
$DECvalue = $DEC->fetch_assoc();
$pdf->Cell(10, 5, $DECvalue['COUNT(A_status)'], 1, 0, 'C');

$JAN = $mysqli->query("SELECT COUNT(A_status) FROM attendance WHERE SR_number = '{$_SESSION['SR_number']}' AND MONTHNAME(A_date) = 'January' AND A_status = 'LATE'");
$JANvalue = $JAN->fetch_assoc();
$pdf->Cell(10, 5, $JANvalue['COUNT(A_status)'], 1, 0, 'C');

$FEB = $mysqli->query("SELECT COUNT(A_status) FROM attendance WHERE SR_number = '{$_SESSION['SR_number']}' AND MONTHNAME(A_date) = 'February' AND A_status = 'LATE'");
$FEBvalue = $FEB->fetch_assoc();
$pdf->Cell(10, 5, $FEBvalue['COUNT(A_status)'], 1, 0, 'C');

$MAR = $mysqli->query("SELECT COUNT(A_status) FROM attendance WHERE SR_number = '{$_SESSION['SR_number']}' AND MONTHNAME(A_date) = 'March' AND A_status = 'LATE'");
$MARvalue = $MAR->fetch_assoc();
$pdf->Cell(10, 5, $MARvalue['COUNT(A_status)'], 1, 0, 'C');

$APR = $mysqli->query("SELECT COUNT(A_status) FROM attendance WHERE SR_number = '{$_SESSION['SR_number']}' AND MONTHNAME(A_date) = 'April' AND A_status = 'LATE'");
$APRvalue = $APR->fetch_assoc();
$pdf->Cell(10, 5, $APRvalue['COUNT(A_status)'], 1, 0, 'C');

$MAY = $mysqli->query("SELECT COUNT(A_status) FROM attendance WHERE SR_number = '{$_SESSION['SR_number']}' AND MONTHNAME(A_date) = 'May' AND A_status = 'LATE'");
$MAYvalue = $MAY->fetch_assoc();
$pdf->Cell(10, 5, $MAYvalue['COUNT(A_status)'], 1, 0, 'C');

$JUN = $mysqli->query("SELECT COUNT(A_status) FROM attendance WHERE SR_number = '{$_SESSION['SR_number']}' AND MONTHNAME(A_date) = 'June' AND A_status = 'LATE'");
$JUNvalue = $JUN->fetch_assoc();
$pdf->Cell(10, 5, $JUNvalue['COUNT(A_status)'], 1, 0, 'C');

$TOTAL = $mysqli->query("SELECT COUNT(A_status) FROM attendance WHERE SR_number = '{$_SESSION['SR_number']}' AND A_status = 'LATE'");
$TOTALvalue = $TOTAL->fetch_assoc();
