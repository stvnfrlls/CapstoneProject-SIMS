...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-dark navbar-light sticky-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarCollapse">
      <div class="navbar-nav ms-auto p-4 p-lg-0 ">
        ...
        <a href="reminders.php" class="nav-item nav-link" style="color: red; font-size: 14px;">Reminders/Assignments</a>
      ...
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="section-heading">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px; padding-top: 80px;">
  ...
  <!-- Add reminder -->
  <div class="container">
    <div class="text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 800px;">
      <div class="col-lg-12 col-sm-6 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
        <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px; padding-top: 60px;">
          <h5 class="fw-bold text-primary text-uppercase">Add a reminder</h5>
        </div>
        <form>
          <div class="row g-3">
            <div class="col-md-6">
